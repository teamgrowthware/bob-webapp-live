    ...
    <div className="min-h-screen bg-zinc-950 text-white selection:bg-violet-500/30 overflow-x-hidden">
      ...
      <main className="max-w-4xl mx-auto px-6 py-24 relative">
        <motion.div 
          ...
          className="mb-16"
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-xs font-black text-emerald-400 mb-6 uppercase tracking-widest">
            <ShieldCheck size={14} />
            Data Shield Active
          </div>
        ...
        <section className="space-y-12 text-zinc-400 font-medium leading-relaxed">
           <div className="space-y-4">
              <h2 className="text-2xl font-black text-white italic uppercase lg:text-3xl">01. Intel Collection</h2>
           ...
           <div className="space-y-4">
              <h2 className="text-2xl font-black text-white italic uppercase lg:text-3xl">02. Mission Tracking</h2>
           ...
           <div className="space-y-4">
              <h2 className="text-2xl font-black text-white italic uppercase lg:text-3xl">03. Comms & De-briefing</h2>
           ...
           <div className="space-y-4">
              <h2 className="text-2xl font-black text-white italic uppercase lg:text-3xl">04. Safeguard Protocol</h2>
           ...
           <div className="space-y-4">
              <h2 className="text-2xl font-black text-white italic uppercase lg:text-3xl">05. Extraction Rights</h2>
